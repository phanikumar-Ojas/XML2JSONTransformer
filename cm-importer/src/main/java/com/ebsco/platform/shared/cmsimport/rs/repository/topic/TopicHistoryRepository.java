...
public class TopicHistoryRepository extends TopicRepository {
	
	public TopicHistoryRepository(DatabaseClient databaseClient) {
	...
	protected String query() {
		return """
		   		 ...
		   		 WHERE ta.do_not_use = 'FALSE' AND ta.brst_topic IN ('History')
		   """;
	}

	@Override
	protected Topic create(ResultSet rs) throws SQLException {
		return addBrstCategoryTag(new TopicHistory(), rs);
	}
}

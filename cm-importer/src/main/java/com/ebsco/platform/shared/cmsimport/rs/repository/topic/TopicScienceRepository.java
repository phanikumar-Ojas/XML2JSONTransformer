...
public class TopicScienceRepository extends TopicRepository {
	
	public TopicScienceRepository(DatabaseClient databaseClient) {
	...
	protected String query() {
		return """
		   		 ...
		   		 WHERE ta.do_not_use = 'FALSE' AND ta.brst_topic IN ('Science and technology', 'Science and Technology')
		   """;
	}

	@Override
	protected Topic create(ResultSet rs) throws SQLException {
		return addBrstCategoryTag(new TopicScience(), rs);
	}
}
